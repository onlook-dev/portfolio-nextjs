      ...
      >
        ...
        <div className="space-y-3.5">
          ...
          <h1 className="text-primary-white text-nav-primary-heading">
            <span className={`${poppins} text-8xl font-bold text-[#ff0000]`}>Cincy</span>
          </h1>

          {/* NAV LINKS */}
          <div className="flex gap-5 text-primary-gray text-nav-primary-list flex-col items-center">
            {navLinks.map((link) => (
              <p
                className={`${
                  pathname === link.route
